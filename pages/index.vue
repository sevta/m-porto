<template>
  <div class="max-w-4xl mx-auto px-5 sm:px-0">
    <div class="divide-y-2 divide-gray-300 divide-opacity-30">
      ...
      <div class="py-6 prose max-w-4xl w-full">
        <div class="text-4xl  tracking-tighter dark:text-white">
          Timeline
        </div>
        <div class="text-gray-500 mt-4 dark:text-gray-200">
          <ul class="list-disc">
            <li class="list-none">
              ...
              <div>
                I'm excited to help grow the Next.js community and continue
                building the optimal workflow for front-end developers.
              </div>
            </li>
            <li class="list-none">
              <div class="">
      ...
      <div class="py-6 prose max-w-4xl w-full">
        ...
        <div class="text-gray-500 mt-4 dark:text-gray-200">
          <ul class="list-disc">
            <li class="list-none" v-for="item in 16" :key="item">
              <div class="">
                Kargo.co.id 2016
              </div>
              <div>
